                    ...
                    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-1">
                                ...
                                <input type="number" name="price" id="price" value="{{ old('price') }}" required min="0" step="1000" class="w-full bg-gray-50 text-gray-500 border border-gray-300 rounded-md shadow-sm px-4 py-2 focus:ring-nibras-magenta focus:border-nibras-magenta sm:text-sm" readonly title="Harga dasar otomatis disinkronisasi dari varian Anda">
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (addVariantBtn) {
                addVariantBtn.addEventListener('click', function() {
                    ...
                    row.innerHTML = `
                        <td class="px-4 py-3">
                            <input type="text" name="variants[${variantIndex}][size]" required placeholder="Contoh: XL-3XL" class="w-full border border-gray-300 rounded-md py-1.5 px-3 focus:outline-none focus:border-nibras-magenta text-sm">
                        </td>
                        <td class="px-4 py-3">
                            <input type="number" name="variants[\${variantIndex}][price]" required min="0" step="1000" placeholder="Harga Jual" class="w-full border border-gray-300 rounded-md py-1.5 px-3 focus:outline-none focus:border-nibras-magenta text-sm variant-price">
                        </td>
                        <td class="px-4 py-3">
                            <input type="number" name="variants[\${variantIndex}][purchase_price]" required min="0" step="1000" placeholder="Harga Modal" class="w-full border border-gray-300 rounded-md py-1.5 px-3 focus:outline-none focus:border-nibras-magenta text-sm">
                        </td>
                        <td class="px-4 py-3">
                            <input type="number" name="variants[${variantIndex}][stock]" required min="0" value="0" class="w-full border border-gray-300 rounded-md py-1.5 px-3 focus:outline-none focus:border-nibras-magenta text-sm">
                        </td>
                        <td class="px-4 py-3 text-center">
                            <button type="button" class="remove-variant-btn text-red-500 hover:text-red-700 p-1 rounded transition-colors" title="Hapus">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                ...
                // Auto sync "Harga Dasar" parameter with the first variant price if user leaves base price empty or changes variant price
                variantsContainer.addEventListener('input', function(e) {
                    if (e.target.classList.contains('variant-price')) {
                        ...
                        // Find the minimum price from all variants to set as base price

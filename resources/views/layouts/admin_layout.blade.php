...
<body class="text-gray-800 flex h-screen overflow-hidden">
    ...
    <aside id="sidebar" class="w-64 bg-white shadow-lg flex flex-col h-full z-30 absolute md:relative -translate-x-full md:translate-x-0 transition-transform duration-300">
        ...
        <nav class="flex-grow p-4 space-y-2 overflow-y-auto">
            ...
            <a href="{{ route('admin.banners.index') }}" class="flex items-center gap-3 px-4 py-3 {{ request()->is('admin/banners*') ? 'bg-pink-50 text-nibras-magenta font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-nibras-magenta' }} rounded-lg transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                Kelola Banner
            </a>
            <a href="{{ route('admin.category_brand.index') }}" class="flex items-center gap-3 px-4 py-3 {{ request()->is('admin/category-brand*') || request()->is('admin/categories*') || request()->is('admin/brands*') ? 'bg-pink-50 text-nibras-magenta font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-nibras-magenta' }} rounded-lg transition-colors">
            ...
            <a href="{{ route('admin.settings.index') }}" class="flex items-center gap-3 px-4 py-3 {{ request()->is('admin/settings*') ? 'bg-pink-50 text-nibras-magenta font-medium' : 'text-gray-600 hover:bg-gray-50 hover:text-nibras-magenta' }} rounded-lg transition-colors">

...
<body class="text-gray-800 min-h-screen flex flex-col">
    ...
    <main class="flex-grow flex items-center justify-center p-6 relative w-full pt-10 pb-10">
        ...
        <!-- Register Card -->
        <div class="bg-white rounded-xl container-glow w-full max-w-lg p-8 md:p-10 relative z-10 border-t-4 border-nibras-magenta">
            
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-gray-900 mb-2">Buat Akun Baru</h1>
                <p class="text-sm text-gray-500">Bergabunglah dan lengkapi profil Anda</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password" name="password" type="password" required minlength="8" maxlength="20" class="pl-10 pr-10 appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-nibras-magenta focus:border-nibras-magenta sm:text-sm transition-colors" placeholder="••••••••">
                            <button type="button" id="togglePassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-nibras-magenta focus:outline-none">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" id="toggleConfirmPassword" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-nibras-magenta focus:outline-none">
                                <svg id="eyeConfirmIcon" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                </svg>
                                <svg id="eyeConfirmSlashIcon" class="h-5 w-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"></path>
                                </svg>
                            </button>
                        </div>
            ...
            <div class="mt-6 border-t border-gray-200 pt-6">
                <p class="text-center text-sm text-gray-600">
                    Sudah punya akun? 
                    <a href="/login" class="font-medium text-nibras-magenta hover:text-pink-700 transition-colors">Masuk di sini</a>
                </p>
            </div>
        </div>
    </main>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const eyeConfirmIcon = document.querySelector('#eyeConfirmIcon');
            const eyeConfirmSlashIcon = document.querySelector('#eyeConfirmSlashIcon');
            ...
            if (toggleConfirmPassword) {
                toggleConfirmPassword.addEventListener('click', function () {
                    ...
                    eyeConfirmSlashIcon.classList.toggle('hidden');
                });
            }
        });
    </script>

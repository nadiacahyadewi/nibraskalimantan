    ...
    <main class="flex-grow flex items-center justify-center p-6 relative w-full">
        ...
        <div class="bg-white rounded-xl container-glow w-full max-w-md p-8 relative z-10 border-t-4 border-nibras-magenta">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-sm text-gray-500">Masukkan kata sandi baru Anda.</p>
            </div>
            ...
            <form action="{{ route('password.update') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" name="email" type="email" autocomplete="email" required value="{{ $email ?? old('email') }}" readonly class="pl-10 appearance-none block w-full px-3 py-2 border border-gray-300 bg-gray-50 text-gray-500 rounded-md shadow-sm sm:text-sm">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password" name="password" type="password" required class="pl-10 pr-10 appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-nibras-magenta focus:border-nibras-magenta sm:text-sm transition-colors" placeholder="••••••••">
                    </div>
                </div>

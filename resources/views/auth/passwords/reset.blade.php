...
<head>
    ...
    <title>Reset Password - Febia Nibras Kalsel</title>
    <!-- Tailwind CSS -->
...
<body class="bg-white m-0 p-0 min-h-screen flex text-gray-800">
    ...
    <div class="w-full flex flex-col md:flex-row min-h-screen">
        ...
        <div class="hidden md:flex md:w-1/2 relative bg-gray-100 overflow-hidden">
            <!-- Background Image -->
            <img src="{{ asset('assets/loginbg.png') }}" class="absolute inset-0 w-full h-full object-cover object-center" alt="Reset Password Banner">
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-20">
            ...
            <div class="w-full max-w-md relative">
                ...
                <form action="{{ route('password.update') }}" method="POST" class="space-y-5">
                    ...
                    <!-- Email Field -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Email Anda</label>
                        <div class="relative">
                            ...
                            <input name="email" type="email" value="{{ $email ?? old('email') }}" required readonly class="w-full pl-11 pr-4 py-3 border border-gray-200 bg-gray-50 text-gray-500 rounded-lg focus:outline-none text-sm placeholder-gray-400">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password" name="password" type="password" required class="w-full pl-11 pr-11 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500 text-sm placeholder-gray-400 transition-colors" placeholder="••••••••">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password_confirmation" name="password_confirmation" type="password" required class="w-full pl-11 pr-11 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-red-500 focus:border-red-500 text-sm placeholder-gray-400 transition-colors" placeholder="••••••••">

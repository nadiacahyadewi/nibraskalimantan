            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password" name="password" type="password" autocomplete="current-password" required class="pl-10 pr-10 appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-nibras-magenta focus:border-nibras-magenta sm:text-sm transition-colors" placeholder="••••••••">
                ...
                <div class="flex items-center justify-between mt-2">
                    ...
                    <div class="text-sm">
                        <a href="{{ route('password.request') }}" class="font-medium text-nibras-magenta hover:text-pink-700 transition-colors">
                            Lupa password?
                        </a>
                    </div>
                </div>
